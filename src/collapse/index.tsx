...
function Close(props: { onClick: () => void }) {
  return (
    <svg onClick={props.onClick} className='lite-icon' viewBox='0 0 1024 1024' width='28' height='26'>
      <path fill='rgba(255,255,255,0.9)' d='M136.596875 727.26875h750.80625v84.46875H136.596875zM136.596875 212.684375h750.80625v84.46875H136.596875zM136.596875 469.765625h750.80625v84.46875H136.596875z'></path>
    </svg>
  );
}
