...
export function Expand(props: IProps) {
  ...
  return (
    <div style={props.style} className={`lite-expand ${props.className ? props.className : ''}`}>
      <div className='lite-expand-title'>
        <Cross style={{ margin: '0 3px' }} cross={expand} onClick={() => setExpand(!expand)} />
        <span className='lite-expand-title-text'>{props.title}</span>
      </div>
...
function Cross(props: ICrossProps) {
  return (
    <svg onClick={props.onClick} className={`${typeof props.className === 'undefined' ? '' : props.className}`} style={{ cursor: 'pointer', ...props.style }} width='18' height='18' viewBox='0 0 1024 1024'>
      <path d='M896 544H128c-17.6 0-32-14.4-32-32s14.4-32 32-32h768c17.6 0 32 14.4 32 32s-14.4 32-32 32z' fill='#515151'></path>
      {
        (typeof props.cross === 'undefined' || props.cross === true) &&
        <path d='M512 928c-17.6 0-32-14.4-32-32V128c0-17.6 14.4-32 32-32s32 14.4 32 32v768c0 17.6-14.4 32-32 32z' fill='#515151'></path>
      }
    </svg>
  );
}
